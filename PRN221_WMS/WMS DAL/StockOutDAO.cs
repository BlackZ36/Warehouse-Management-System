...
namespace WMS_DAL
{
    public class StockOutDAO
    {
        ...
        {
            PRN221_WMSContext db = new PRN221_WMSContext();
        ...
        public List<StockOutDetail> GetStockOutDetailById(int id)
        {
            ...
            try
            {
                using (var db = new PRN221_WMSContext())
                {
                    stockOutDetail = db.StockOutDetails
                    .Include(x => x.StockOut)
                    .Include(x => x.Product)
        ...
        public void UpdateStockOuts(StockOut NewstockOut)
        {
            ...
            try
            {
                ...
                {
                    File.AppendAllText(fileName, jsonFormatContent);
                }
                ...
                {
                    File.WriteAllText(fileName2, DateTime.Now + "\n" + jsonFormatContent2 + "\n");
                }
                else
                {
                    File.AppendAllText(fileName2, DateTime.Now + "\n" + jsonFormatContent2 + "\n");
                }
            }
            catch (Exception ex)
            {
